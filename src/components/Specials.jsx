...
export default function Specials() {
  return (
    <section id="specials" className="relative py-20 sm:py-24 lg:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {specials.map((item, i) => (
            <ScrollReveal key={item.title} delay={i + 1}>
              <div
                className={`group relative bg-white border ${item.border} hover:border-navy-300 rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full`}
              >
                {/* Top accent line */}
                ...
                <div className="p-6 sm:p-7">
                  ...
                  <h3 className="font-display text-xl sm:text-2xl font-bold text-navy-950 mb-2 sm:mb-3 group-hover:text-navy-700 transition-colors">
                    {item.title}
                  </h3>
        ...
        <ScrollReveal delay={3}>
          <div className="mt-8 sm:mt-12 flex items-center justify-center gap-3 px-4 sm:px-6 py-3 sm:py-4 bg-navy-50 border border-navy-100 rounded-xl">
