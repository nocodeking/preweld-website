...
export default function Navbar() {
  ...
  return (
    <>
        ...
        >
          <div className="px-6 pb-6 space-y-1 bg-white border-b border-gray-200 shadow-lg">
            ...
            <a
              href="tel:0123272694"
              onClick={() => setOpen(false)}
              className="block px-4 py-3 bg-navy-900 text-white text-center font-semibold rounded-lg"
            >
              Call 012 327 2694
            </a>
          </div>
      ...
      {/* Delivery banner — flush below header */}
      <div className="fixed top-[56px] md:top-[88px] left-0 right-0 z-40 bg-emerald-600 text-white shadow-md">
