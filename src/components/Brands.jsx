      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {brands.map((brand) => (
            <div
              key={brand}
              className="px-5 py-2.5 bg-white border border-gray-200 hover:border-navy-200 rounded-lg text-gray-600 hover:text-navy-900 font-medium text-sm transition-all duration-200 hover:shadow-sm cursor-default"
            >
              {brand}
            </div>
          ))}
